...
st.markdown("---")
st.markdown("Encontre mais detalhes do projeto no.  [README](https://github.com/FlaysonSantos/previsao-falhas-atendimento-saude/blob/main/projeto-atendimento-inteligente/README.md)")
st.markdown("---")
